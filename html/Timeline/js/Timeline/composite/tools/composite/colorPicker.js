...
var Lesvg = d3.select('body #timeline #tools #colorpicker').append('svg')
 ...
 function draw_palet(){
    ...
    var palet_container = Lesvg.append('g').attr('id','palet_container');
 ...
 function drawGrapheText(x,y,id=null,value,s_color){
   var graphe = Lesvg.append('g').attr('id','text_graphe');
...
var choosed_palet = {
  container:Lesvg.append('g').attr('class','choosed_palet'),
  x:50,
  y:450,
  width:30,
  height:10,
